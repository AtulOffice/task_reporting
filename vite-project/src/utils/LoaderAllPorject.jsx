...
const LoadingSkeltionAll = () => {
  return (
    // this line changes for the  1080 display  please do not remove it for the  normal display
    <div className="max-w-8xl  ml-64 rounded-4xl animate-pulse min-h-screen p-10 bg-gradient-to-r from-purple-200 via-pink-200 to-yellow-200 flex flex-col justify-center space-y-8">
